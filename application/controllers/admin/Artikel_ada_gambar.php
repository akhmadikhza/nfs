...
class Artikel extends CI_Controller
{
    ...
    public function komentar()
    {
        ...
        $file_baru       = '';
        $tanggal_post   = date('Y-m-d H:i:s');
        $this->db->query("INSERT INTO komen VALUES('','$slug_materi',$comment_materi,'$id_user','$id_materi','$id_kelas','$isi_komen','$file_baru','$tanggal_post')");
        redirect('admin/artikel/read/' . $slug_materi);
    }
    ...
    public function show()
    {
        ...
        $materi = $this->materi_model->listing();
        $data = array(
            'title' => 'Data Artikel(' . count($materi) . ')',
            'materi' => $materi,
            'isi' => 'admin/materi/show'
        );
