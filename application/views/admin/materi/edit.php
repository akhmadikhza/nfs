<div class="col-lg-6">
	...
	echo form_open_multipart(base_url('admin/artikel/edit/') . $materi['id_materi']);
...
<div class="row">
	<div class="form-group">
		<div class="col-lg-4">
			<img src="<?= base_url('assets/image/artikel/thumbs/') . $materi['file_materi']; ?>" class="img-thumbnail">
...
<div class="form-group mt-3">
	...
	<a href="<?= base_url('admin/artikel'); ?> "><button type="button" class="btn btn-danger">Back</button></a>
