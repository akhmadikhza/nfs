...
<div class="row">
    ...
    <?php
    $slug =  $slug;
    $query = $this->db->query("SELECT * FROM komen LEFT JOIN user ON komen.id_user = user.id_user WHERE slug_materi = '$slug'");
...
<div class=" row">
    ...
    <div class="col-lg-8">
        <form action="<?= base_url('admin/artikel/kirim'); ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
